        ...
        const socialMediaTasks = [
          {
            ...
            description: 'Create all social media content for the project',
            type: 'Social Media',
            status: 'Todo',
            isCompleted: false,
                ...
                <div style={{ display: 'flex', gap: '1rem', justifyContent: 'flex-end', marginTop: '1rem' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      borderRadius: '0.5rem',
                      background: creatingTask || !newTaskData.projectId || !newTaskData.title.trim() ? '#cbd5e1' : '#ec4899',
                      color: 'white',
            ...
            >
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    background: isUpdatingTaskInModal || !editTaskData.title.trim() ? '#cbd5e1' : '#ec4899',
                    color: 'white',
                    border: 'none',
                    padding: '0.875rem 1.75rem',
                    borderRadius: '10px',
