...
const SEODashboard: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      ...
      // Projects that are in SEO/GEO-related stages even if they don't have SEO tasks yet
      ...
      if (projectTasks.length === 0) {
        ...
        const seoTasks = [
          ...
          },
          {
            ...
            description: 'Optimize for geographic/local search',
            type: 'SEO',
            status: 'Todo',
            isCompleted: false,
            assignedToId: user.id,
                ...
                <div style={{ display: 'flex', gap: '1rem', justifyContent: 'flex-end', marginTop: '1rem' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      borderRadius: '0.5rem',
                      background: creatingTask || !newTaskData.projectId || !newTaskData.title.trim() ? '#cbd5e1' : '#14b8a6',
                      color: 'white',
                    ...
                    >
                      ...
                      {hasAttachment && attachmentUrl && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem', background: 'white', borderRadius: '4px' }}>
                          <FaLink style={{ color: '#14b8a6', fontSize: '0.875rem' }} />
                          <a 
                            href={attachmentUrl} 
                            target="_blank" 
                            rel="noopener noreferrer"
